...
ifeq ($(PRERELEASE), true)
	...
	# TODO: Goreleaser will generate prerelease yamls, but they won't be pushed since docker images aren't pushed either
	@$(GORELEASER_BIN) build --config $(CURDIR)/.goreleaser.yml --skip-validate --snapshot --rm-dist
else
	@echo "===> $(INTEGRATION) === [release/build] build binares and docker images"
	@$(GORELEASER_BIN) release --config $(CURDIR)/.goreleaser.yml --skip-validate --rm-dist
	# Push s3 manifests generated by goreleaser hook
